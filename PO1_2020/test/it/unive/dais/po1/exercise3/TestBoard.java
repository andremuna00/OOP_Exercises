...
public class TestBoard {
    ...
    @Test
    public void testBoardDiagonalCircle() throws GameException {
    ...
    @Test
    public void testFillCellTwice() throws GameException {
        Board board = ClassProvider.getBoard();
        boolean added = board.putMark(Mark.getCircle(), 0, 0);
        Assert.assertTrue(added);
    ...
    @Test
    public void testBoardDiagonalCross() throws GameException {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardHorizontalCircle() throws GameException {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardHorizontalCross() throws GameException {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardVerticalCircle() throws GameException {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardVerticalCross() throws GameException {
        Board board = ClassProvider.getBoard();
