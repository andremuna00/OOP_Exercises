...
public class TestBoard {
    ...
    @Test
    public void testBoardDiagonalCircle() {
    ...
    @Test
    public void testBoardDiagonalCross() {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardHorizontalCircle() {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardHorizontalCross() {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardVerticalCircle() {
        Board board = ClassProvider.getBoard();
    ...
    @Test
    public void testBoardVerticalCross() {
        Board board = ClassProvider.getBoard();
